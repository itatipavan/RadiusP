...
export const AuthProvider = ({ children }) => {
  ...
  const hasPermission = (permission) => {
    ...
    const permissions = {
      admin: [
        'view_dashboard','manage_students','edit_students','delete_students','manage_employees','edit_employees','delete_employees','manage_universities','edit_universities','delete_universities','manage_applications','edit_applications','delete_applications','view_reports','manage_system'
      ],
      counselor: [
  ...
  const getRoleDisplayName = (role) => {
    const roleNames = { admin: 'Administrator', counselor: 'Counselor', employee: 'Employee' };
  ...
  const value = { user, loading, login, logout, updateProfile, hasPermission, getRoleDisplayName, canAccessRoute };
